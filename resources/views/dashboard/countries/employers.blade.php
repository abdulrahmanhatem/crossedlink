        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link active" href="{{url('dashboard/countries/employers')}}"
                           role="tab" aria-controls="v-pills-all"><i class="icon icon-home2"></i>Employers Countries</a>
                    </li>
                    <li>
                        <a class="nav-link active" href="{{url('dashboard/countries/workers')}}"
                           role="tab" aria-controls="v-pills-all"><i class="icon icon-home2"></i>Workers countries</a>
                    </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('dashboard/countries/'.$country->id.'/edit')}}">
                                                            {{Helper::getCountryByKey($country->code)}}
                                                        </a>
                                                    </td>

                                                    @if($country->role == 0)
                                                        <td><span class="r-3 badge badge-warning ">Workers</span></td>
                                                    @elseif($country->role == 1)   
