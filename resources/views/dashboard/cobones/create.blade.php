        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    {!! Form::open(['action'=>'CoboneController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation'])!!}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row mt-1">
                                            <div class="form-group col-4 m-0">
                                                ...
                                                {!! Form::text('code', '', ['class' => "form-control r-0 light s-12", 'placeholder' => 'Cobone code'])!!}
                                            ...
                                            <div class="form-group col-4 m-0">
                                                ...
                                                {!! Form::text('percentage','', ['class' => "form-control r-0 light s-12", 'placeholder' => 'percentage', 'id' => 'percentage'])!!}
                                                <div class="valid-feedback">
                                                    Looks Good
                                                </div>
                                                <div class="invalid-feedback">
