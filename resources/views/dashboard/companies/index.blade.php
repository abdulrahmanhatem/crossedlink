                ...
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    <li>
                        <a class="nav-link active"  href="{{url('dashboard/companies')}}"
                           ><i class="icon icon-home2"></i>All Companies</a>
                    </li>
                    ...
                    <li class="float-right search-li">
                        {!! Form::open(['action'=>'CompanyController@search', 'method'=>'GET', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation d-block'])!!}
                                    ...
                                    <form>
                                        <table class="table table-striped table-hover r-0">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td >
                                                        <a href="{{url('dashboard/companies/'. $user->id)}}">
