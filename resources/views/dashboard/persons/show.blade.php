                    ...
                    <div class="row big-row">
                        <div class="col-md-3 col-sm-12 pb-4 text-center view-face">
                            <div class="avatar">
                                ...
                                <img src="{{ asset('uploads/images/profile_images/'.$person->profile_image ) }}" alt="" class="d-block mx-auto shadow rounded-pill mb-4 worker-avatar">
                                @else 
                            ...
                            @if (!empty($person->company_name))
                                <h5 class="mb-2 text-center worker-name">{{ ucwords($person->company_name) }}</h5>
                            @else 
                                <h5 class="mb-2 text-center worker-name">{{ ucwords($person->name) }}</h5>     
                            @endif
                            ...
                            <div class="nationality">
                                ...
                                <div>
                                    @if (!empty($person->experience))
                                        {{ $person->experience }} Years Of Experience
                                    @else    
                                        @if (auth()->user()->id == $person->id)
                            ...
                            @if (!empty($person->phone)  || !empty($person->phone_2))
                            <div class="phone">
                            ...
                            <div class="country">
                                @if (!empty($person->country))
                                    <span>
                                        ...
                                        {{ Helper::getCountryByKey($person->country) }}
                                    </span>
                                @else    
                                    @if (auth()->user()->id == $person->id)
                            ...
                            <div class="birth">
                                @if (auth()->user()->role == 2)
                                    @if (!empty($person->employers))
                                        <span>
                                            {{ $person->employers }} Employers
                                        </span>
                                    @else    
                                        @if (auth()->user()->id == $person->id)
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 p-0">
                                                        ...
                                                        <div class="border-bottom p-2 text-left view-about">
                                                                ...
                                                                @if(!empty($person->overview ))
                                                                    @if(auth()->user()->id == $person->id)
                                                                        <h5 class="text-dark">About Us</h5>
                                                                    @else
                                                                        @if (!empty($person->company_name))
                                                                            <h5 class="text-dark">About {{ ucwords($person->company_name) }}</h5>
                                                                        @else 
                                                                            <h5 class="text-dark">About {{ ucwords($person->name) }}</h5>  
                                                                        @endif
                                                                    @endif
                                                                    <p class="text-muted text-justify">{{ $person->overview }}</p>
                                                                @else    
                                            ...
                                            <div class="tab-pane fade show " id="education" role="tabpanel" aria-labelledby="education-tab">
                                                <div class="row education">
                                                        ...
                                                        @if(!empty($person->services ))
                                                            @if (!empty($person->services))
                                                                <div class="border-bottom p-2 text-left  view-about">
                                                                    ...
                                                                    @endif
                                                                    <p class="text-muted text-justify p-2">{{ $person->services }}</p>
                                                                </div>
                                                            @endif
                                                        @else    
                                                            @if (auth()->user()->id == $person->id)
                                                    ...
                                                    <div class="hours mt-4 p-2 text-left  view-about">
                                                        ...
                                                        @if(empty($person->sa) && empty($person->su) && empty($person->mo) && empty($person->tu) && empty($person->we) && empty($person->th) && empty($person->fa))
                                                                ...
                                                                <ul class="list-inline mb-0">
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted border-bottom pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->sa }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted border-bottom pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->su }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted border-bottom pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->mo }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted border-bottom pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->tu }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted border-bottom pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->we }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted border-bottom pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->th }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                    ...
                                                                    @if (!empty($person->sa))
                                                                        <li class="clearfix text-muted pb-3">
                                                                            ...
                                                                            <div class="float-right">
                                                                                <h5 class="f-13 mb-0">{{ $person->fr }}</h5>
                                                                            </div>
                                                                        </li>
                                                                    @endif
                                                                </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group app-label mt-2">
                    {!! Form::open(['action'=> ['WorkerController@update', $person->id], 'method'=>'POST', 'enctype' =>'multipart/form-data' ])!!}
                    <div class="">

                    
                        @if ($person->gov_id == 'verified')
                            <i class="fal fa-badge-check"></i>
                            Verified
                        @else 
                            <img src="{{ asset('uploads/images/gov_id/'.$person->gov_id) }}" alt="" class="w-50 d-block m-auto">
                        @endif
                    </div>
                    <div class="row">
