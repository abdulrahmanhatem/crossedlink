        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    <li>
                        <a class="nav-link active" id="v-pills-all-tab" href="{{url('dashboard/workers')}}"
                          ><i class="icon icon-home2"></i>All Workers</a>
                    </li>
                    ...
                    <li class="float-right search-li">
                        {!! Form::open(['action'=>'WorkerController@search', 'method'=>'GET', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation d-block'])!!}
                                    ...
                                    <form>
                                        <table class="table table-striped table-hover r-0">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="{{url('dashboard/workers/'. $user->id)}}">
