        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    {!! Form::open(['action'=>'JobRequestController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation'])!!}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row mt-1">
                                            ...
                                            <div class="form-group col-4 m-0">
                                                ...
                                                {!! Form::select('job_id', Helper::jobsNames(),'', ['class' => "form-control r-0 light s-12", 'placeholder' => 'Country Name', 'id' => 'job_id'])!!}
                                                <div class="valid-feedback">
                                                    Looks Good
                                                </div>
                                                <div class="invalid-feedback">
