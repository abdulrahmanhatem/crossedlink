        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link active" href="{{url('dashboard/categories/companies')}}"
                    ...
                    <li class="float-right search-li">
                        {!! Form::open(['action'=>'CategoryController@search', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation d-block'])!!}
