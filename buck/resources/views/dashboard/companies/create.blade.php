        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    {!! Form::open(['action'=>'CompanyController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation'])!!}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row profile-container">
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            <div class="form-row mt-1">
                                                <div class="form-group col-12 m-0">
                                                    ...
                                                    {!! Form::text('company_name', '',  ['id' => 'company_name', 'class' => "form-control r-0 light s-12", 'placeholder' => 'Comapny Name'])!!}
                                        ...
                                        <div class="form-row mt-1">
                                            <div class="form-group col-6 m-0">
                                                ...
                                                {!! Form::text('email', '',  ['class' => "form-control r-0 light s-12", 'placeholder' => 'company@email.com', 'id' => 'email', 'required'])!!}
                                                <div class="valid-feedback">
                                                    Looks Good
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-6 m-0">
                                                ...
                                                {!! Form::text('website', '',  ['class' => "form-control r-0 light s-12", 'placeholder' => 'WWW.example.com', 'id' => 'website'])!!}
                                            </div>
                                            <div class="form-group col-6 m-0">
                                            ...
                                            {{--<div class="form-group col-6 m-0">
                                                {!! Form::label('phone_2', '<i class="icon-phone mr-2"></i>Another Phone(Optional)', ['class' => 'col-form-label s-12'], false) !!}
                                                {!! Form::text('phone_2', '',  ['class' => "form-control r-0 light s-12", 'placeholder' => '05112345678', 'id' => 'phone_2'])!!}
                                            </div>--}}
                                            ...
                                            <div class="form-group col-sm-6 m-0">
                                                {!! Form::label('experience', 'Company Experience Years', ['class' => 'col-form-label s-12'], false) !!}
                                                {!! Form::text('experience', '',  ['id' => 'experience', 'class' => "form-control r-0 light s-12", 'placeholder' => 'Company Experience'])!!}
                                            </div>
                                            <div class="form-group col-sm-6 m-0">
                                                {!! Form::label('employers', 'Employers', ['class' => 'col-form-label s-12'], false) !!}
                                                {!! Form::text('employers', '',  ['class' => "form-control r-0 light s-12", 'placeholder' => 'Employers', 'id' => 'employers'])!!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-row">
                                            <div class="form-group col-sm-6 m-0 overview">
                                                ...
                                                {!! Form::textarea('overview', '',  ['id' => 'experience', 'class' => "form-control r-0 light s-12", 'placeholder' => 'Company Overview'])!!}
                                            </div>
                                            <div class="form-group col-sm-6 m-0">
                                                {!! Form::label('services', 'Services', ['class' => 'col-form-label s-12'], false) !!}
                                                {!! Form::textarea('services', '',  ['class' => "form-control r-0 light s-12", 'placeholder' => 'Company Services', 'id' => 'services'])!!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 offset-md-1">
                                        ...
                                        <h5 class="card-title mt-4">Work Hours</h5>
                                        <div class="form-row">  
                                            <div class="form-row">
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    {!! Form::label('sa', trans('main.Saturday'), ['class' => 'col-form-label s-12'], false) !!}
                                                    {!! Form::select('sa_from',  Helper::operatingHours() ,'',['id' => 'sa', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('sa_to',  Helper::operatingHours() ,'',['id' => 'sa', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                                ...
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    ...
                                                    {!! Form::select('sa_from',  Helper::operatingHours() ,'',['id' => 'sa', 'class' => "form-control r-0 light s-12", 'placeholder' =>  trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('su_to',  Helper::operatingHours() ,'',  ['id' => 'su', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                               
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    {!! Form::label('mo', trans('main.Monday'), ['class' => 'col-form-label s-12'], false) !!}
                                                    {!! Form::select('mo_from',  Helper::operatingHours() ,'',  ['id' => 'mo', 'class' => "form-control r-0 light s-12", 'placeholder' =>  trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('mo_to',  Helper::operatingHours() ,'',  ['id' => 'mo', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                           
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    {!! Form::label('tu', trans('main.Tuesday'), ['class' => 'col-form-label s-12'], false) !!}
                                                    {!! Form::select('tu_from',  Helper::operatingHours() ,'',  ['id' => 'tu', 'class' => "form-control r-0 light s-12", 'placeholder' =>  trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('tu_to',  Helper::operatingHours() ,'',  ['id' => 'tu', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                          
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    {!! Form::label('we', trans('main.Wednesday'), ['class' => 'col-form-label s-12'], false) !!}
                                                    {!! Form::select('we_from',  Helper::operatingHours() ,'',  ['id' => 'we', 'class' => "form-control r-0 light s-12", 'placeholder' =>  trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('we_to',  Helper::operatingHours() ,'',  ['id' => 'we', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                             
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    {!! Form::label('th', trans('main.Thursday'), ['class' => 'col-form-label s-12'], false) !!}
                                                    {!! Form::select('th_from',  Helper::operatingHours() , '',  ['id' => 'th', 'class' => "form-control r-0 light s-12", 'placeholder' =>  trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('th_to',  Helper::operatingHours() ,'',  ['id' => 'th', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                               
                                                <div class="form-group col-sm-3 col-sm-6 m-0 o-hours">
                                                    {!! Form::label('fr', trans('main.Friday'), ['class' => 'col-form-label s-12'], false) !!}
                                                    {!! Form::select('fr_from',  Helper::operatingHours() ,'',  ['id' => 'fr', 'class' => "form-control r-0 light s-12", 'placeholder' =>  trans('main.From'), 'type' => 'number'])!!}
                                                    {!! Form::select('fr_to',  Helper::operatingHours() ,'' ,  ['id' => 'fr', 'class' => "form-control r-0 light s-12", 'placeholder' => trans('main.To'), 'type' => 'number'])!!}
                                                </div>
                                        </div>
                                            </div>
                                        </div>
