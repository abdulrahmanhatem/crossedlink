        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    {!! Form::open(['action'=>'CountryController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation'])!!}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row mt-1">
                                            <div class="form-group col-6 m-0">
                                                ...
                                                {!! Form::text('name', '', ['class' => "form-control r-0 light s-12", 'placeholder' => 'Country Name'])!!}
                                            ...
                                            <div class="form-group col-6 m-0">
                                                ...
                                                {!! Form::text('code',  '',  ['class' => "form-control r-0 light s-12", 'placeholder' => 'Country Code(iso2)', 'id' => 'country'])!!}
                                            </div>
                                        </div>  
                                    </div>
                                </div>
