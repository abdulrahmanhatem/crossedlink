                ...
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    <li>
                        <a class="nav-link active"  href="{{url('dashboard/cities')}}"
                           role="tab"><i class="icon icon-home2"></i>All Cities</a>
                    </li>
                    ...
                    <li class="float-right search-li">
                        {!! Form::open(['action'=>'CityController@search', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation d-block'])!!}
