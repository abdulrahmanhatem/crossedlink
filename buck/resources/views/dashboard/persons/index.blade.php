                ...
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    <li>
                        <a class="nav-link active"  href="{{url('dashboard/personal')}}"
                          ><i class="icon icon-home2"></i>All Personal</a>
                    </li>
                    ...
                    <li class="float-right search-li">
                        {!! Form::open(['action'=>'PersonController@search', 'method'=>'GET', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'needs-validation d-block'])!!}
                                    ...
                                    <form>
                                        <table class="table table-striped table-hover r-0">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="{{url('dashboard/personal/'. $user->id)}}">
