...
<div>
    <div class="mt-4 p-3 card-view" v-for="worker in workers" v-if="workers.length > 0">
        <div class="row position-relative">
            <span v-if="worker.UnlockWorker == 1" v-for="req in unlock">
                    <span class="unlocked-badge"  v-if="req.worker_id == worker.id ">Unlocked</span>
            </span>
            <div class="col-md-9">
                ...
                <div class="candidates-list-desc overflow-hidden job-single-meta  pt-2">
                    ...
                    <ul class="list-unstyled">
                            ...
                            <li class="text-muted" v-if="worker.city_name !== null || worker.country_name !== null">
                                ...
                                <li class="text-muted" v-for="(exp , index) in experience" v-if="worker.experience+1 == index && worker.experience !== null">
                ...
                <div class="candidates-list-fav-btn text-right">
                    ...
                    <div class="candidates-listing-btn mt-1" v-if="role == 1 || role == 2">
                        ...
                        <a :href="'https://crossedlink.com/profiles/'+worker.id" class="btn btn-sm mb-1 text-green btn-card-option with-unlock" >
                            ...
                            <input type="submit" value="unlock" class="btn text-red btn-sm btn-card-option" name="create-unlock">
                            </form>
                        </span>
                    </div>
                </div>
    ...
    <div v-else>
         <span class="m-5 empty-to-show box">No Candidates To Show</span>
    </div>
    </div>
</template>
    ...
    props:['unlock','role','workers','user_id'],
     ...
     data(){
      ...
      favourite(id,worker_id){
            ...
            // ,getData(){
            //     axios.get('https://crossedlink.com/workers/search/ajax').then(respnose=>{
            //     this.workers = respnose.data.worker.data; //assign worker
