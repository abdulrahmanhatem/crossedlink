        ...
        if (array_key_exists("worker",$data)){
            if (in_array ($data['worker'], $data)) {
                return User::create([
                    ...
                    'role' => 0,
                    'phone_code' => $data['countryCode'] . '-'.preg_replace('/[^0-9]/', '', $data['phone_no']),
                    'phone' => $data['countryCode'] . '-'.preg_replace('/[^0-9]/', '', $data['phone_no']),
                    // 'g-captcha' => $data['g-reca ptcha-response']
        ...
        if (array_key_exists("personal",$data)){
            if (in_array ($data['personal'], $data)) {
                return User::create([
                    ...
                    'role' => 1,
                    'g-captcha' => $data['g-recaptcha-response']
                ]);
